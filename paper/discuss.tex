...
simple type theory ... and key features of dimensional
analysis. Furthermore, the observed values we have .. are mathematical
objects over which we can write probability distributions. 

* enhanced verification beyond the increased transparency
* example: simple extension: units of measure
* probabilistic modeling: BUGS, autobayes, MlWin
