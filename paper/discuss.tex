...
dimension of a multidimensional signal to represent time, and a second
dimension to index the vector dimension. But this only works for
vector quantities, and forces us to think in terms of linear
