...
analyses'' for submission to \emph{Nature Methods}. Although
scientific experiments can be seen as \emph{programs} that observe and
manipulate the physical work, there has been very little work in
applying theoretical computer science to experimentation itself. Here,
we model physiological experimentation using concepts from modern
programming languages and type theory. We show that this approach
gives solutions to several outstanding problems in neuroinformatics:
...
define the semantic web. Although in this paper we have focused on
physiology, we outline a generalized theory and discuss its
