...
This suggests that it is worth investigating a unified and transparent
...
Here, we define a formal framework for physiology. We show that there
...
inspecting an experiment definition, automated decision procedures
could verify statements about experiments that indicate sound
