...
\keywords{neuroinformatics | functional programming | dynamic clamp | neurophysiology}
...
\cite{Chang2006}. The combination of bias, human error, and
unverified software, has led to the suggestion that many --- perhaps
most --- published research findings are flawed \cite{Ioannidis2005,
  Merali2010}.
...
evaluation of mathematical expressions \cite{Church1941}.
